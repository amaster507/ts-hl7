...
import { findSegmentInMsg } from '../src/class/findSegmentPos'
import Msg from '../src/class/Message'

const PMU = new Msg(fs.readFileSync('./sample.hl7', 'utf8'))

const OUL = new Msg(fs.readFileSync('./sample2.hl7', 'utf8'))
